...
exports.getAllUserRoles = function(businessId = null, callback) {
    let sql = "SELECT userRoles.id, userRoles.roleName, userRoles.roleType, userRoles.roleDescription, userRoles.userPermissionsId, userRoles.createdAt as roleCreatedAt, userRoles.updatedAt as roleUpdatedAt, userRoles.state, userPermissions.* FROM ?? LEFT JOIN ?? ON ?? = ?? WHERE ?? = ? OR ?? IS NULL";
